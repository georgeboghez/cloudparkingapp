 ...
 */
function callOnDetachedOnSessionReceivers(connectionContext, contextOrConnectionError) {
    return __awaiter(this, void 0, void 0, function* () {
...
(function (ConnectionContext) {
    function create(config, tokenCredential, options) {
        ...
        const disconnected = (context) => __awaiter(this, void 0, void 0, function* () {
            ...
            if (state.wasConnectionCloseCalled) {
                ...
                if (numSessionReceivers) {
                    ...
                    yield callOnDetachedOnSessionReceivers(connectionContext, connectionError || contextError);
                }
            }
        ...
        function cleanConnectionContext() {
            return __awaiter(this, void 0, void 0, function* () {
    ...
    function close(context) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                logger.verbose(`${logPrefix} Permanently closing ${messageSessionNames.length} session receivers.`);
                ...
                logger.verbose(`${logPrefix} Permanently closing ${managementClientsEntityPaths.length} session receivers.`);
