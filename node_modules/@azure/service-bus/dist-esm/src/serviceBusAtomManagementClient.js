...
import { bearerTokenAuthenticationPolicy, createPipelineFromOptions, RestError, ServiceClient, signingPolicy, stripRequest, stripResponse, URLBuilder, WebResource } from "@azure/core-http";
...
export class ServiceBusAdministrationClient extends ServiceClient {
    ...
    operationOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const response = yield this.getResource("$namespaceinfo", this.namespaceResourceSerializer, updatedOptions);
    ...
    options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const response = yield this.putResource(queueName, buildQueueOptions(options || {}), this.queueResourceSerializer, false, updatedOptions);
    ...
    operationOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const response = yield this.getResource(queueName, this.queueResourceSerializer, updatedOptions);
                return this.buildQueueResponse(response);
            }
            catch (e) {
                span.setStatus({
     ...
     * @throws `RestError` with code and statusCode representing the standard set of REST API errors.
     */
    getQueueRuntimeProperties(queueName, 
    // eslint-disable-next-line @azure/azure-sdk/ts-naming-options
    operationOptions) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    getQueues(options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const response = yield this.listResources("$Resources/Queues", updatedOptions, this.queueResourceSerializer);
    ...
    operationOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const response = yield this.putResource(queue.name, buildQueueOptions(queue), this.queueResourceSerializer, true, updatedOptions);
                return this.buildQueueResponse(response);
            }
            catch (e) {
                span.setStatus({
    ...
    operationOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const response = yield this.deleteResource(queueName, this.queueResourceSerializer, updatedOptions);
    ...
    queueExists(queueName, operationOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                try {
                    yield this.getQueue(queueName, updatedOptions);
                }
                catch (error) {
    ...
    options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const response = yield this.putResource(topicName, buildTopicOptions(options || {}), this.topicResourceSerializer, false, updatedOptions);
    ...
    operationOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const response = yield this.getResource(topicName, this.topicResourceSerializer, updatedOptions);
                return this.buildTopicResponse(response);
            }
            catch (e) {
                span.setStatus({
     ...
     * @throws `RestError` with code and statusCode representing the standard set of REST API errors.
     */
    getTopicRuntimeProperties(topicName, 
    // eslint-disable-next-line @azure/azure-sdk/ts-naming-options
    operationOptions) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    getTopics(options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const response = yield this.listResources("$Resources/Topics", updatedOptions, this.topicResourceSerializer);
    ...
    operationOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const response = yield this.putResource(topic.name, buildTopicOptions(topic), this.topicResourceSerializer, true, updatedOptions);
                return this.buildTopicResponse(response);
            }
            catch (e) {
                span.setStatus({
    ...
    operationOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const response = yield this.deleteResource(topicName, this.topicResourceSerializer, updatedOptions);
                return { _response: getHttpResponseOnly(response) };
            }
            catch (e) {
                span.setStatus({
    ...
    topicExists(topicName, operationOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                try {
                    yield this.getTopic(topicName, updatedOptions);
                }
                catch (error) {
                    if (error.code === "MessageEntityNotFoundError") {
                        return false;
    ...
    options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const response = yield this.putResource(fullPath, buildSubscriptionOptions(options || {}), this.subscriptionResourceSerializer, false, updatedOptions);
    ...
    operationOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const fullPath = this.getSubscriptionPath(topicName, subscriptionName);
                const response = yield this.getResource(fullPath, this.subscriptionResourceSerializer, updatedOptions);
                return this.buildSubscriptionResponse(response);
            }
            catch (e) {
                span.setStatus({
     ...
     * @throws `RestError` with code and statusCode representing the standard set of REST API errors.
     */
    getSubscriptionRuntimeProperties(topicName, subscriptionName, 
    // eslint-disable-next-line @azure/azure-sdk/ts-naming-options
    operationOptions) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    getSubscriptions(topicName, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const response = yield this.listResources(topicName + "/Subscriptions/", updatedOptions, this.subscriptionResourceSerializer);
    ...
    operationOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const response = yield this.putResource(fullPath, buildSubscriptionOptions(subscription), this.subscriptionResourceSerializer, true, updatedOptions);
                return this.buildSubscriptionResponse(response);
            }
            catch (e) {
                span.setStatus({
    ...
    operationOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const fullPath = this.getSubscriptionPath(topicName, subscriptionName);
                const response = yield this.deleteResource(fullPath, this.subscriptionResourceSerializer, updatedOptions);
                return { _response: getHttpResponseOnly(response) };
            }
            catch (e) {
                span.setStatus({
     ...
     * @param operationOptions - The options that can be used to abort, trace and control other configurations on the HTTP request.
     */
    subscriptionExists(topicName, subscriptionName, 
    // eslint-disable-next-line @azure/azure-sdk/ts-naming-options
    operationOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                try {
                    yield this.getSubscription(topicName, subscriptionName, updatedOptions);
                }
                catch (error) {
                    if (error.code === "MessageEntityNotFoundError") {
                        return false;
    ...
    createRule(topicName, subscriptionName, ruleName, ruleFilter, ruleActionOrOperationOptions, 
    // eslint-disable-next-line @azure/azure-sdk/ts-naming-options
    operationOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const response = yield this.putResource(fullPath, { name: ruleName, filter: ruleFilter, action: ruleAction }, this.ruleResourceSerializer, false, updatedOptions);
     ...
     * @throws `RestError` with code and statusCode representing the standard set of REST API errors.
     */
    getRule(topicName, subscriptionName, ruleName, 
    // eslint-disable-next-line @azure/azure-sdk/ts-naming-options
    operationOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const fullPath = this.getRulePath(topicName, subscriptionName, ruleName);
                const response = yield this.getResource(fullPath, this.ruleResourceSerializer, updatedOptions);
                return this.buildRuleResponse(response);
            }
            catch (e) {
                span.setStatus({
    ...
    getRules(topicName, subscriptionName, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const response = yield this.listResources(fullPath, updatedOptions, this.ruleResourceSerializer);
     ...
     * @throws `RestError` with code and statusCode representing the standard set of REST API errors.
     */
    updateRule(topicName, subscriptionName, rule, 
    // eslint-disable-next-line @azure/azure-sdk/ts-naming-options
    operationOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const response = yield this.putResource(fullPath, rule, this.ruleResourceSerializer, true, updatedOptions);
                return this.buildRuleResponse(response);
            }
            catch (e) {
                span.setStatus({
    ...
    operationOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const fullPath = this.getRulePath(topicName, subscriptionName, ruleName);
                const response = yield this.deleteResource(fullPath, this.ruleResourceSerializer, updatedOptions);
                return { _response: getHttpResponseOnly(response) };
            }
            catch (e) {
                span.setStatus({
     ...
     *
     */
    ruleExists(topicName, subscriptionName, ruleName, 
    // eslint-disable-next-line @azure/azure-sdk/ts-naming-options
    operationOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                try {
                    yield this.getRule(topicName, subscriptionName, ruleName, updatedOptions);
                }
                catch (error) {
                    if (error.code === "MessageEntityNotFoundError") {
                        return false;
            ...
            try {
                ...
                if (queueOrSubscriptionFields.ForwardTo ||
                    ...
                    const token = this.credentials instanceof SasServiceClientCredentials
                        ...
                        : (yield this.credentials.getToken([AMQPConstants.aadServiceBusScope])).token;
                    if (queueOrSubscriptionFields.ForwardTo) {
    ...
    getResource(name, serializer, operationOptions = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const response = yield executeAtomXmlOperation(this, webResource, serializer, updatedOptions);
                if (!isDefined(response.parsedBody) ||
                    (Array.isArray(response.parsedBody) && response.parsedBody.length === 0)) {
                    const err = new RestError(`The messaging entity "${name}" being requested cannot be found.`, "MessageEntityNotFoundError", response.status, stripRequest(webResource), stripResponse(response));
                    throw err;
                }
                return response;
            }
    ...
    buildNamespacePropertiesResponse(response) {
        try {
            ...
            throw new RestError(`Error occurred while parsing the response body - cannot form a namespace object using the response from the service.`, RestError.PARSE_ERROR, response.status, stripRequest(response.request), stripResponse(response));
        }
    }
