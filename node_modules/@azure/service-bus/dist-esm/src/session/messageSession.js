...
export class MessageSession extends LinkEntity {
    ...
    constructor(connectionContext, entityPath, _providedSessionId, options) {
        ...
        this._batchingReceiverLite = new BatchingReceiverLite(connectionContext, entityPath, (_abortSignal) => __awaiter(this, void 0, void 0, function* () {
            return this.link;
        }), this.receiveMode);
    ...
    onDetached(connectionError) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield this.close(connectionError);
        });
    }
    /**
