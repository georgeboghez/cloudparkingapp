...
import { toRheaMessage, getMessagePropertyTypeMismatchError } from "./serviceBusMessage";
...
export class ServiceBusMessageBatchImpl {
    ...
    tryAddMessage(originalMessage, options = {}) {
        ...
        throwIfNotValidServiceBusMessage(originalMessage, "Provided value for 'message' must be of type ServiceBusMessage.");
