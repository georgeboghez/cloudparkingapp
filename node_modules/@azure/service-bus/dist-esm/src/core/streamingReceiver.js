...
import { RetryOperationType, retry, ConditionErrorNameMapper } from "@azure/core-amqp";
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            while (true) {
                ...
                try {
                    ...
                    logger.logError(err, `${this.logPrefix} Error thrown in retry cycle ${numRetryCycles}, restarting retry cycle with retry options`, this._retryOptions);
                    continue;
                }
            }
        });
    ...
    onDetached(receiverError) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                this._receiverHelper.addCredit(this.maxConcurrentCalls);
                logger.verbose(`${this.logPrefix} onDetached: link has been reestablished, added ${this.maxConcurrentCalls} credits.`);
            }
            finally {
                this._isDetaching = false;
            }
