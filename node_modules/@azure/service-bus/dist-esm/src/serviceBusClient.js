...
import { createConnectionContextForConnectionString, createConnectionContextForTokenCredential } from "./constructorHelpers";
...
export class ServiceBusClient {
    ...
    acceptSession(queueOrTopicName1, optionsOrSubscriptionNameOrSessionId2, optionsOrSessionId3, 
    // eslint-disable-next-line @azure/azure-sdk/ts-naming-options
    options4) {
    ...
    acceptNextSession(queueOrTopicName1, optionsOrSubscriptionName2, 
    // eslint-disable-next-line @azure/azure-sdk/ts-naming-options
    options3) {
        return __awaiter(this, void 0, void 0, function* () {
            validateEntityPath(this._connectionContext.config, queueOrTopicName1);
