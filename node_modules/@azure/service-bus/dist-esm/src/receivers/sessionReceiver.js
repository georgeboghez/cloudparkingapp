...
export class ServiceBusSessionReceiverImpl {
    ...
    renewSessionLock(options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const renewSessionLockOperationPromise = () => __awaiter(this, void 0, void 0, function* () {
    ...
    setSessionState(state, options = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            this._throwIfReceiverOrConnectionClosed();
            const setSessionStateOperationPromise = () => __awaiter(this, void 0, void 0, function* () {
                yield this._context
                    .getManagementClient(this.entityPath)
    ...
    getSessionState(options = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            this._throwIfReceiverOrConnectionClosed();
            const getSessionStateOperationPromise = () => __awaiter(this, void 0, void 0, function* () {
    ...
    receiveMessages(maxMessageCount, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const receiveBatchOperationPromise = () => __awaiter(this, void 0, void 0, function* () {
                var _a;
                const receivedMessages = yield this._messageSession.receiveMessages(maxMessageCount, (_a = options === null || options === void 0 ? void 0 : options.maxWaitTimeInMs) !== null && _a !== void 0 ? _a : Constants.defaultOperationTimeoutInMs, defaultMaxTimeAfterFirstMessageForBatchingMs, options !== null && options !== void 0 ? options : {});
    ...
    subscribe(handlers, options) {
        ...
        this._registerMessageHandler((message) => __awaiter(this, void 0, void 0, function* () {
